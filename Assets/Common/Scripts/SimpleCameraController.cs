...
namespace Common.Scripts {
  ...
  public class SimpleCameraController : MonoBehaviour {
    ...
    void Update() {
      ...
      var position_lerp_pct =
          1f - Mathf.Exp((Mathf.Log(1f - 0.99f) / this._PositionLerpTime) * Time.deltaTime);
      var rotation_lerp_pct =
          1f - Mathf.Exp((Mathf.Log(1f - 0.99f) / this._RotationLerpTime) * Time.deltaTime);

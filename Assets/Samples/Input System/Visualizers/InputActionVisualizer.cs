  ...
  public class InputActionVisualizer : InputVisualizer {
    ...
    protected new void OnGUI() {
      ...
      if (m_ShowControlName && m_ActiveControlName != null)
        VisualizationHelpers.DrawText(m_ActiveControlName,
      ...
      if (m_Action == null && !string.IsNullOrEmpty(m_ActionName)) {
        ...
        foreach (var action in enabledActions) {
          ...
          if (mapName != null
              ...
              && string.Compare(mapName, action.actionMap.name, StringComparison.InvariantCultureIgnoreCase)
              != 0)
            continue;
        ...
        case Visualization.Value:
          switch (m_Action.type) {
            case InputActionType.Button:
              m_Visualizer = new VisualizationHelpers.ScalarVisualizer<float> {limitMax = 1};
              break;
              ...
              if (!string.IsNullOrEmpty(m_Action.expectedControlType)) {
                ...
                if (layout != null) {
                  ...
                  if (valueType == typeof(float))
                    ...
                    m_Visualizer = new VisualizationHelpers.ScalarVisualizer<int> {limitMax = 1};

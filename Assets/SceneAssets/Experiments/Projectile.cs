...
namespace SceneAssets.Experiments {
  ...
  public class Projectile : MonoBehaviour {
    ...
    void Launch() {
      ...
      var target_xz_pos = new Vector3(x : position1.x, y : 0.0f, z : position1.z);
      ...
      var local_velocity = new Vector3(0f, y : vy, z : vz);
    ...
    void SetNewTarget() {
      ...
      var random_vector_on_ground_plane = Quaternion.AngleAxis(angle : random_angle, axis : rotation_axis) * Vector3.right;
      ...
      var height_offset_vector = new Vector3(0, y : height_offset, z : 0) * above_or_below_ground;

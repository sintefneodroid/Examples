...
namespace SceneAssets.Manipulator.Scripts {
  ...
  public class InjectRandomRigidbodyNoise : MonoBehaviour {
    ...
    void Update() {
      this._rigidbody.AddForce(Random.insideUnitSphere * this._magnitude, mode : this._forceMode);
      this._rigidbody.AddTorque(Random.insideUnitSphere * this._magnitude, mode : this._forceMode);
    }
  }
}

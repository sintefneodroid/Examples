...
namespace Unity_Technologies.Recorder.Framework.Core.Editor
{
    ...
    class OutputPathDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var fullPath = Unity_Technologies.Recorder.Framework.Core.Engine.OutputPath.GetFullPath( (Unity_Technologies.Recorder.Framework.Core.Engine.OutputPath.ERoot)property.FindPropertyRelative("m_root").intValue, property.FindPropertyRelative("m_leaf").stringValue);
            if (GUI.Button( btnRect, new GUIContent("...", fullPath)))
            {
                ...
                {
                    var newValue = Unity_Technologies.Recorder.Framework.Core.Engine.OutputPath.FromPath(newPath);

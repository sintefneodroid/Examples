...
namespace UnityEditor.Recorder
{
    public class AboutBox : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Space(52f);
            GUILayout.Label("Recorder " + Unity_Technologies.Recorder.Framework.Core.Engine.RecorderVersion.Stage, EditorStyles.boldLabel);
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Space(52f);
            GUILayout.Label(string.Format("Version {0}", Unity_Technologies.Recorder.Framework.Core.Engine.RecorderVersion.Tag));
            GUILayout.EndHorizontal();
            GUILayout.Space(4);

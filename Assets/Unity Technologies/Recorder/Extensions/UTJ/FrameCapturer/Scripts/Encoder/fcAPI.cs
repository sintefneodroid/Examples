...
namespace Unity_Technologies.Recorder.Extensions.UTJ.FrameCapturer.Scripts.Encoder
{
    public static class fcAPI
    {
        ...
        {
            public int handle;
            public void Release() { fcReleaseDeferredCall(this); this.handle = 0; }
        ...
        {
            public IntPtr ptr;
            public void Release() { fcReleaseStream(this); this.ptr = IntPtr.Zero; }
        ...
        {
            public IntPtr ptr;
            public void Release() { fcReleaseContext(this.ptr); this.ptr = IntPtr.Zero; }
